...
public class Player : Combatant
{
    ...
    void Start()
    {
        ...
        MaxHP = SceneData.MaxHP;
        MaxMP = SceneData.MaxMP;
        Offense = SceneData.Offense;
        Defense = SceneData.Defense;
        FireRes = SceneData.FireRes;
        ElecRes = SceneData.ElecRes;
        Mobility = SceneData.Mobility;
